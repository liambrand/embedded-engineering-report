...
\end{lstlisting} 
		...
		\section{Question 2}
		The formula for calculating the CAN message response time is the following.
		
		\begin{equation}
		R\textsubscript{m} = J\textsubscript{m} + w\textsubscript{m} + C\textsubscript{m}
		\end{equation}
		Where J is queuing jitter, w is worst-case queuing delay and C is worst-case message transmission time.
