	...
	\chapter{Reliability}
		...
		\section{Section 2}
			...
			\subsection{(c)}
				...
				As can be seen from the results of the solo sensor and the sensor array tests, the standard deviation with a majority of faulty sensors still manages to remain much lower than the standard deviation of a single faulty sensor. The average value approach's general lower deviation also shows that the impact of noise on the sensor readings has been reduced somewhat as well.
