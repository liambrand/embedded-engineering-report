...
\end{lstlisting}
			...
			A time triggered scheduler was used to run the EngineMonitor's tachoT task. The scheduler was relatively simple, it used a task table containing an array of task control blocks. Each block had a pointer to the task, a delay, and a period. For tachoT, the 
